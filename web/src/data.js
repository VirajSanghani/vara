...
export const PARTS_V3 = [
  ...
  { id: 'display', group: 'core', mat: 'screen', kind: 'rep', exZ: -72, side: 1, label: true,
  ...
  { id: 'speaker', group: 'core', mat: 'black', kind: 'rep', exZ: -72, side: -1, label: false, anchor: [13, -56, -15] },
  { id: 'camera', group: 'core', mat: 'black', kind: 'rep', exZ: -12, side: 1, label: true,
  ...
  { id: 'pi', group: 'core', mat: 'pcb', kind: 'rep', exZ: -54, side: -1, label: true,
  ...
  { id: 'carrier', group: 'core', mat: 'pcb', kind: 'rep', exZ: -38, side: 1, label: true,
  ...
  { id: 'battery', group: 'core', mat: 'cell', kind: 'rep', exZ: -24, side: -1, label: true,
  ...
  { id: 'pogo', group: 'core', mat: 'gold', kind: 'designed', exZ: 40, side: -1, label: true,
    anchor: [6, 7, 7], title: 'Pogo pins ×6', what: 'V+, GND, I²C SDA/SCL, CD#, INT.', why: 'DESIGNED contacts (connector-spec v0.2).' },
  { id: 'core_back', group: 'core', mat: 'stone', kind: 'designed', exZ: 24, side: -1, label: true,
